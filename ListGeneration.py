...
class ListGeneration:
    def __init__(self):
        ...
        self.List_1K_Ascending += [x for x in range(1_000, 10_000)]
        ...
        self.List_1K_Random = [random.randint(0, 1_000) for x in range(0, 1_000)]
        self.List_10K_Random = [random.randint(0, 10_000) for x in range(0, 10_000)]
